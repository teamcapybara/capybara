shared_examples_for "attach_file" do
  ...
  describe "#attach_file" do
    ...
    context "with multipart form" do
      it "should submit multiple file contents" do
        ...
        @session.attach_file "form_multiple_documents", [@test_file_path, @another_test_file_path]
        @session.click_button('Upload Multiple')
        @session.body.should include(">2 |")#contains two files
