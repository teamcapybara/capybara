...
module Capybara
  module Node
    module Matchers
      ...
      # @see #assert_selector?
      #
      # @overload has_selector?([kind], locator, **options)
      ...
      #
      # @overload has_no_selector?([kind], locator, **options)
      ...
      #
      # @overload assert_selector([kind], locator, **options)
      # @param (see Capybara::Node::Finders#all)
      ...
      # @see #assert_selector
      #
      # @overload assert_all_of_selectors([kind], *locators, **options)
      #   @param [Symbol] kind
      ...
      #
      # @see #assert_no_selector
      # @see #assert_all_of_selectors
      #
      # @overload assert_none_of_selectors([kind], *locators, **options)
      #   @param [Symbol] kind
      #   @param [Array<String>] locators
      #   @param [Hash] options
      #
      ...
      # @see #assert_all_of_selectors
      #
      # @overload assert_any_of_selectors([kind], *locators, **options)
      #   @param [Symbol] kind
      #   @param [Array<String>] locators
      #   @param [Hash] options
      #
      ...
      #
      # @overload assert_no_selector([kind], locator, **options)
      ...
      # checked.
      #
      # @see #has_checked_field?
      #
      # @param (see #has_checked_field?)
      # @return [Boolean]                 Whether it doesn't exist
      #
      ...
      #
      # @overload assert_matches_selector([kind], locator, **options)
      # @param (see Capybara::Node::Finders#all)
      ...
      #
      # @see #assert_matches_selector
      #
      # @overload matches_selector?([kind], locator, **options)
      ...
      # Usage is identical to {#matches_selector?}.
      #
      # @see #matches_selector?
      #
      # @overload not_matches_selector?([kind], locator, **options)
      # @param (see #matches_selector?)
      # @return [Boolean]
      #
