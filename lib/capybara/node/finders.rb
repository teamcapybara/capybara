...
module Capybara
  module Node
    module Finders
      ...
      #
      # @!method find([kind], locator, **options)
      #
      # @param (see #all)
      #
      # @!macro system_filters
      #   @option options [false, true, Numeric] :wait Maximum time to wait for matching element to appear. Defaults to {Capybara.configure default_max_wait_time}.
      #   @option options [String, Regexp] :text      Only find elements which contain this text or match this regexp
      #   @option options [String, Boolean] :exact_text When String the elements contained text must match exactly, when Boolean controls whether the +:text+ option must match exactly. Defaults to {Capybara.configure exact_text}.
      #   @option options [Boolean] :normalize_ws Whether the +:text+ / +:exact_text+ options are compared against elment text with whitespace normalized or as returned by the driver. Defaults to {Capybara.configure default_normalize_ws}.
      ...
      # @macro waiting_behavior
      #
      # @overload ancestor([kind], locator, **options)
      # @param (see #find)
      # @return (see #find)
      # @raise (see #find)
      #
      ...
      # @macro waiting_behavior
      #
      # @overload sibling([kind], locator, **options)
      # @param (see #find)
      # @return (see #find)
      # @raise (see #find)
      #
      ...
      # @macro waiting_behavior
      #
      # @overload find_field(locator = nil, **options)
      #   @macro locator_parameter
      #
      ...
      # @macro waiting_behavior
      #
      # @overload find_link(locator = nil, **options)
      #   @macro locator_parameter
      #
      ...
      # @macro waiting_behavior
      #
      # @overload find_button(locator = nil, **options)
      #   @macro locator_parameter
      #
      ...
      # @macro waiting_behavior
      #
      # @overload find_by_id(id, **options)
      ...
      ##
      # @!method all([kind], locator = nil, **options)
      #
      ...
      # @overload all([kind], locator = nil, **options)
      # @overload all([kind], locator = nil, **options, &filter_block)
