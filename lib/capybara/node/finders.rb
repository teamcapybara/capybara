module Capybara
  module Node
    module Finders
      ...
      # is not found or if multiple matches are found. The error message can be customized through the +:message+ option.
      #
      ...
      # @raise  [Capybara::MultipleMatchesFound]  If multiple elements are found
      #
      def find(*args)
        query = query(*args)
        query.find = true
