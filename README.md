...
comes with Rack::Test. WebKit and Selenium are supported through external gems.
...
*not* Selenium RC. Selenium-Webdriver is no longer packaged as a dependency so if you would like use it, add
